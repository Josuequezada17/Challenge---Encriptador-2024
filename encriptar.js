...
function encriptar(texto) {
    ...
    if(tieneCaracteresEspecialesOMayusculas(mensaje)) {
        limpiarCajas();
...
function desencriptar(texto) {
    ...
    if(tieneCaracteresEspecialesOMayusculas(mensaje)) {
        ...
        while(start < end) {
            ...
            if(caracteres[start] === 'e') {
                ...
                //console.log('inicio:', start, 'letra en la que va: ', caracteres[start], 'end:', end);
    ...
    //asignarTextoElemento("#presentacionTextoResultado", mensaje);
...
function tieneCaracteresEspecialesOMayusculas(cadena) {
...
function copiar() {
    console.log('entrando a la funcion copiar');
